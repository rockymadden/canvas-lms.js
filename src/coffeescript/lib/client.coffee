...
clientClosure = (@baseUrl, @token) ->
  withSession: (f) ->
    ...
    f(Object.freeze(
      ...
      getAccountEnrollment: bilby.bind(http.get)(http, (i) -> "/api/v1/accounts/#{ i.account_id }/enrollments/#{ i.enrollment_id }")
      ...
      deleteCourseDiscussionTopic: bilby.bind(http.delete)(http, (i) -> "/api/v1/courses/#{ i.course_id }/discussion_topics/#{ i.discussion_topic_id }")
      ...
      getCourseDiscussionTopic: bilby.bind(http.get)(http, (i) -> "/api/v1/courses/#{ i.course_id || i }/discussion_topics/#{ i.discussion_topic_id }")
      getCourseDiscussionTopics: bilby.bind(http.get)(http, (i) -> "/api/v1/courses/#{ i.course_id || i }/discussion_topics")
      ...
      postCourseDiscussionTopic: bilby.bind(http.post)(http, (i) -> "/api/v1/courses/#{ i.course_id || i }/discussion_topics")
      ...
      putCourseDiscussionTopic: bilby.bind(http.put)(http, (i) -> "/api/v1/courses/#{ i.course_id }/discussion_topics/#{ i.discussion_topic_id }")
